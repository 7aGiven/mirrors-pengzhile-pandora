...
[![Issues](https://img.shields.io/github/issues-raw/pengzhile/pandora)](./issues)
[![Commits](https://img.shields.io/github/last-commit/pengzhile/pandora/master)](./commits/master)
...
[![PyPi workflow](./actions/workflows/python-publish.yml/badge.svg)](./actions/workflows/python-publish.yml)
[![Docker workflow](./actions/workflows/docker-publish.yml/badge.svg)](./actions/workflows/docker-publish.yml)
...
![t0](./raw/master/doc/images/t0.png)

### 2. Access denied. Sorry, you have been blocked
### &nbsp;&nbsp;&nbsp;经典问题，只能到处找可用VPN，费时费力，更费钱。移动端访问更难。痛！
![t1.1](./raw/master/doc/images/t1.1.png)

### 3. ChatGPT is at capacity right now 
### &nbsp;&nbsp;&nbsp;系统负载高，白嫖用户不给用。痛！
![t2](./raw/master/doc/images/t2.png)

### 4. This content may violate our <u>content policy</u>. 
### &nbsp;&nbsp;&nbsp;道德审查，多触发几次可能就封号了。痛！！！
![t3](./raw/master/doc/images/t3.png)

### 5. Something went wrong. 
### &nbsp;&nbsp;&nbsp;吃着火锅唱着歌，突然就出故障了。痛！
![t4](./raw/master/doc/images/t4.png)

### 6. 手机和电脑的模型不通用，顾这个就顾不到那个，痛！
![t7](./raw/master/doc/images/t7.png)
...
## 界面截图
  ...
  ![alt Screenshot5](./raw/master/doc/images/s05.png)<br>
  ![alt Screenshot10](./raw/master/doc/images/s12.jpeg)

  </summary>

  ![alt Screenshot1](./raw/master/doc/images/s01.png)<br>
  ![alt Screenshot2](./raw/master/doc/images/s02.png)<br>
  ![alt Screenshot3](./raw/master/doc/images/s03.png)<br>
  ![alt Screenshot4](./raw/master/doc/images/s04.png)<br>
  ![alt Screenshot6](./raw/master/doc/images/s06.png)<br>
  ![alt Screenshot11](./raw/master/doc/images/s11.jpeg)

  </details>

## 如何搭建运行

* 访问 [doc/wiki.md](./blob/master/doc/wiki.md) 获得详细指导。
...
[![Star History Chart](https://contrib.rocks/image?repo=pengzhile/pandora)](./graphs/contributors)
